...
//dd($data_announcement);
        ...
        $data_employment=  DB::table('employee_employment')->where('employee_id', $employee_id)->get();
        $data_education=  DB::table('employee_educations')->where('employee_id', $employee_id)->get();
        $data_work_experience=  DB::table('employee_work_experience')->where('employee_id', $employee_id)->get();
        $education_level=SettingsConstans::all()->where('type', 'Education Level')->sortByDesc('value');
//        dd($data_employee);
        //dd($data_employment);
        return view('Employee.profile', compact('document_type','data_employee','employee_id','data_document','data_announcement','data_employment','data_education','education_level','data_work_experience'));
