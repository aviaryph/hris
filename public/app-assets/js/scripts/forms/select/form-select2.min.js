!function (e, t, r) {
    ...
    }), r(".select2-placeholder-multiple").select2({placeholder: "Select State"}), r(".hide-search").select2({minimumResultsForSearch: 1 / 0}), r(".max-length").select2({
        maximumSelectionLength: 2,
        placeholder: "Select maximum 2 items"
    });
    var a = r(".js-example-events");
    a.select2({placeholder: "DOM Events"}), a.on("select2:open", function (e) {
    ...
    var l = r(".js-example-programmatic").select2(), c = r(".js-example-programmatic-multi").select2();
    c.select2({placeholder: "Programmatic Events"}), r(".js-programmatic-set-val").on("click", function () {
    ...
    r(".select2-data-array").select2({
    ...
    }), r(".select2-tags").select2({tags: !0}), r(".select2-tokenizer").select2({
        tags: !0,
        tokenSeparators: [",", " "]
    ...
    }), r(".select2-language").select2({language: "es"}), r(".select2-rtl").select2({
        placeholder: "RTL Select",
        dir: "rtl"
    }), r(".select2-diacritics").select2({placeholder: "Type 'aero'"}), r(".select2-theme").select2({
        placeholder: "Classic Theme",
        theme: "classic"
    }), r(".select2-templating").select2({
        templateResult: o,
        templateSelection: o
    }), r(".select2-size-lg").select2({containerCssClass: "select-lg"}), r(".select2-size-sm").select2({containerCssClass: "select-sm"}), r(".select2-size-xs").select2({containerCssClass: "select-xs"}), r(".select2-bg").each(function (e, t) {
        var s = "", a = "", l = r(this).data("bgcolor");
        ...
        r(this).select2({containerCssClass: c})
    }), r(".select2-border").each(function (e, t) {
        var s = "", a = "", l = r(this).data("border-color");
        ...
        var c = "bg-" + l + s + " " + r(this).data("text-color") + a + " border-" + l + " border-darken-2 ";
        r(this).select2({dropdownCssClass: c})
    }), r(".select2-full-bg").each(function (e, t) {
        var s = "", a = "", l = r(this).data("bgcolor");
        "" !== (s = r(this).data("bgcolor-variation")) && (s = " bg-" + s), "" !== (a = r(this).data("text-variation")) && (a = " " + a);
        var c = "bg-" + l + s + " " + r(this).data("text-color") + a + " border-" + l + " border-darken-2 ";
        r(this).select2({containerCssClass: c, dropdownCssClass: c})
